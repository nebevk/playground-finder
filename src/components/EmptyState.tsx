...
function Illustration({ variant }: { variant: Variant }) {
  ...
  switch (variant) {
    case "reviews":
      return (
        <svg viewBox="0 0 120 100" className="h-16 w-16 text-primary" aria-hidden>
...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center gap-3 rounded-box border border-dashed border-primary/30 bg-primary/5 px-6 py-10 text-center">
